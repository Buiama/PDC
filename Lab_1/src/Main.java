...
//                double[][] MF = add(multiply(multiply(MC, MZ), min(add(B, D))), multiply(multiply(MM, add(MC, MM)), a));
            ...
            long startTime = System.currentTimeMillis();
            Thread tread1 = new Thread(() -> matrix[0] = multiply(multiply(MC, MZ), min(add(B, D))));// matrix[0] = multiply(multiply(MC, MZ), min(add(B, D)))
            Thread tread2 = new Thread(() -> matrix[1] = multiply(multiply(MM, add(MC, MM)), a));// matrix[1] = multiply(multiply(MM, add(MC, MM)), a)
            tread1.start();
            tread2.start();
            try {
                tread1.join();
            ...
            double[][] MF = add(matrix[0], matrix[1]);
        ...
        //simple method with treads
        /*Thread threadVectorSimple = new Thread(new Runnable() {
            @Override
            public void run() {
                double[][] resultMatrix1 = new double[1][];
                double[][] resultMatrix2 = new double[1][];
                long startTime = System.currentTimeMillis();
                Thread tread1 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        resultMatrix1[0] = multiply(MC, B);
                    }
                });
                Thread tread2 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        resultMatrix2[0] = multiply(MM, D);
                    }
                });
                tread1.start();
                tread2.start();
                ...
                double[] C = subtract(resultMatrix1[0], resultMatrix2[0]);
                timeVectorSimple.set(System.currentTimeMillis() - startTime);
                synchronized (lock) {
                    System.out.println("\n\nVector C with threads:");
                    output(C, amount);
                    writeToFile("C_simple.txt", C);
                }
            }
        });
        Thread threadMatrixSimple = new Thread(new Runnable() {
            @Override
            public void run() {
//                double[][] MF = add(multiply(multiply(MC, MZ), min(add(B, D))), multiply(multiply(MM, add(MC, MM)), a));
                double[] skalar = new double[1];
                ...
                Thread tread4 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        skalar[0] =min(vector[0]);
                    }
                });// skalar[0] = min(add(B, D))
                Thread tread5 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        matrix[2] = multiply(MM, matrix[1]);
                    }
                });// matrix[2] = multiply(MM, add(MC, MM))
                tread4.start();
                tread5.start();
                try {
                    tread4.join();
                ...
                Thread tread6 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        matrix[3] = multiply(matrix[0], skalar[0]);
                    }
                });// matrix[3] = multiply(multiply(MC, MZ), min(add(B, D)))
                Thread tread7 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        matrix[4] = multiply(matrix[2], a);
                    }
                });// matrix[4] = multiply(multiply(MM, add(MC, MM)), a)
                tread6.start();
                tread7.start();
                try {
                    tread6.join();
                ...
                double[][] MF = add(matrix[3], matrix[4]);
                timeMatrixSimple.set(System.currentTimeMillis() - startTime);
                synchronized (lock) {
                    System.out.println("\nMatrix MF with threads:");
                    output(MF, amount);
                    writeToFile("MF_simple.txt", MF);
                }
            }
...
//                double[][] MF_Kahan = addKahan(multiply(multiplyKahan(MC, MZ), min(addKahan(B, D))), multiply(multiplyKahan(MM, addKahan(MC, MM)), a));
            Thread tread1 = new Thread(() -> matrix[0] = multiply(multiplyKahan(MC, MZ), min(addKahan(B, D))));// matrix[0] = multiply(multiplyKahan(MC, MZ), min(addKahan(B, D))
            Thread tread2 = new Thread(() -> matrix[1] = multiply(multiplyKahan(MM, addKahan(MC, MM)), a));// matrix[1] = multiply(multiplyKahan(MM, addKahan(MC, MM)), a)
            tread1.start();
            tread2.start();
            try {
                tread1.join();
            ...
            double[][] MF_Kahan = addKahan(matrix[0], matrix[1]);
        ...
        //kahan method with threads
        /*Thread threadVectorKahan = new Thread(new Runnable() {
            @Override
            public void run() {
//                double[] C_Kahan = subtractKahan(multiplyKahan(MC, B), multiplyKahan(MM, D));
                double[][] resultMatrix1 = new double[1][];
                ...
                Thread tread1 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        resultMatrix1[0] = multiplyKahan(MC, B);
                    }
                });
                Thread tread2 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        resultMatrix2[0] = multiplyKahan(MM, D);
                    }
                });
                tread1.start();
                tread2.start();
                ...
                double[] C_Kahan = subtractKahan(resultMatrix1[0], resultMatrix2[0]);
                timeVectorKahan.set(System.currentTimeMillis() - startTime);
                synchronized (lock) {
                    System.out.println("\n\nVector C_Kahan with threads:");
                    output(C_Kahan, amount);
                    writeToFile("C_kahan.txt", C_Kahan);
                }
            }
        });
        Thread threadMatrixKahan = new Thread(new Runnable() {
            @Override
            public void run() {
                double[] skalar = new double[1];
                double[][] vector = new double[1][];
...
//                double[][] MF_Kahan = addKahan(multiply(multiplyKahan(MC, MZ), min(addKahan(B, D))), multiply(multiplyKahan(MM, addKahan(MC, MM)), a));
                Thread tread1 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        vector[0] = addKahan(B, D);
                    }
                });// vector[0] = addKahan(B, D)
                Thread tread2 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        matrix[0] = multiplyKahan(MC, MZ);
                    }
                });// matrix[0] = multiplyKahan(MC, MZ)
                Thread tread3 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        matrix[1] = addKahan(MC, MM);
                    }
                });// matrix[1] = addKahan(MC, MM)
                tread1.start();
                tread2.start();
                ...
                });// skalar[0] = min(addKahan(B, D))
                Thread tread5 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        matrix[2] = multiplyKahan(MM, matrix[1]);
                    }
                });// matrix[2] = multiplyKahan(MM, addKahan(MC, MM))
                tread4.start();
                tread5.start();
                try {
                    tread4.join();
                ...
                });// matrix[3] = multiply(multiplyKahan(MC, MZ), min(addKahan(B, D))
                Thread tread7 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        matrix[4] = multiply(matrix[2], a);
                    }
                });// matrix[4] = multiply(multiplyKahan(MM, add(MC, MM)), a)
                tread6.start();
                tread7.start();
                try {
                    tread6.join();
                ...
                double[][] MF_Kahan = addKahan(matrix[3], matrix[4]);
                timeMatrixKahan.set(System.currentTimeMillis() - startTime);
                synchronized (lock) {
                    System.out.println("\nMatrix MF_Kahan with threads:");
                    output(MF_Kahan, amount);
                    writeToFile("MF_kahan.txt", MF_Kahan);
                }
            }
...
//                double[][] MF_KahanBabushka = addKahanBabushka(multiply(multiplyKahanBabushka(MC, MZ), min(addKahanBabushka(B, D))), multiply(multiplyKahanBabushka(MM, addKahanBabushka(MC, MM)), a));
            Thread tread1 = new Thread(() -> matrix[0] = multiply(multiplyKahanBabushka(MC, MZ), min(addKahanBabushka(B, D))));// matrix[0] = multiply(multiplyKahanBabushka(MC, MZ), min(addKahanBabushka(B, D))
            Thread tread2 = new Thread(() -> matrix[1] = multiply(multiplyKahanBabushka(MM, addKahan(MC, MM)), a));// matrix[1] = multiply(multiplyKahanBabushka(MM, add(MC, MM)), a)
            tread1.start();
            tread2.start();
            try {
                tread1.join();
            ...
            double[][] MF_KahanBabushka = addKahanBabushka(matrix[0], matrix[1]);
        ...
        //kahan-babushka method with threads
        /*Thread threadVectorKahanBabushka = new Thread(new Runnable() {
            @Override
            public void run() {
                double[][] resultMatrix1 = new double[1][];
                double[][] resultMatrix2 = new double[1][];
...
//                double[] C_KahanBabushka = subtractKahanBabushka(multiplyKahanBabushka(MC, B), multiplyKahanBabushka(MM, D));
                Thread tread1 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        resultMatrix1[0] = multiplyKahanBabushka(MC, B);
                    }
                });
                Thread tread2 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        resultMatrix2[0] = multiplyKahanBabushka(MM, D);
                    }
                });
                tread1.start();
                tread2.start();
                ...
                double[] C_KahanBabushka = subtractKahanBabushka(resultMatrix1[0], resultMatrix2[0]);
                timeVectorKahanBabushka.set(System.currentTimeMillis() - startTime);
                synchronized (lock) {
                    System.out.println("\n\nVector C_Kahan-Babushka with threads:");
                    output(C_KahanBabushka, amount);
        ...
        Thread threadMatrixKahanBabushka = new Thread(new Runnable() {
            @Override
            public void run() {
                double[] skalar = new double[1];
                double[][] vector = new double[1][];
...
//                double[][] MF_KahanBabushka = addKahanBabushka(multiply(multiplyKahanBabushka(MC, MZ), min(addKahanBabushka(B, D))), multiply(multiplyKahanBabushka(MM, addKahanBabushka(MC, MM)), a));
                Thread tread1 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        vector[0] = addKahanBabushka(B, D);
                    }
                });// vector[0] = addKahanBabushka(B, D)
                Thread tread2 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        matrix[0] = multiplyKahanBabushka(MC, MZ);
                    }
                });// matrix[0] = multiplyKahanBabushka(MC, MZ)
                Thread tread3 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        matrix[1] = addKahanBabushka(MC, MM);
                    }
                });// matrix[1] = addKahanBabushka(MC, MM)
                tread1.start();
                tread2.start();
                ...
                });// skalar[0] = min(addKahanBabushka(B, D))
                Thread tread5 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        matrix[2] = multiplyKahanBabushka(MM, matrix[1]);
                    }
                });// matrix[2] = multiplyKahanBabushka(MM, addKahan(MC, MM))
                tread4.start();
                tread5.start();
                try {
                    tread4.join();
                ...
                });// matrix[3] = multiply(multiplyKahanBabushka(MC, MZ), min(addKahanBabushka(B, D))
                Thread tread7 = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        matrix[4] = multiply(matrix[2], a);
                    }
                });// matrix[4] = multiply(multiplyKahanBabushka(MM, add(MC, MM)), a)
                tread6.start();
                tread7.start();
                try {
                    tread6.join();
                ...
                double[][] MF_KahanBabushka = addKahanBabushka(matrix[3], matrix[4]);
                timeMatrixKahanBabushka.set(System.currentTimeMillis() - startTime);
                synchronized (lock) {
                    System.out.println("\nMatrix MF_Kahan-Babushka with threads:");
                    output(MF_KahanBabushka, amount);
        ...
        try {
            threadVectorSimpleModified.join();
            threadMatrixSimpleModified.join();
            threadVectorKahanModified.join();
            threadMatrixKahanModified.join();
            threadVectorKahanBabushkaModified.join();
            threadMatrixKahanBabushkaModified.join();
        } catch (InterruptedException e) {
            Thread.currentThread().interrupt();
            e.printStackTrace();
        }
        ...
        //treads
        /*threadVectorSimple.start();
        threadMatrixSimple.start();
        threadVectorKahan.start();
        threadMatrixKahan.start();
        threadVectorKahanBabushka.start();
        threadMatrixKahanBabushka.start();

        try {
            threadVectorSimple.join();
            threadMatrixSimple.join();
            threadVectorKahan.join();
            threadMatrixKahan.join();
            threadVectorKahanBabushka.join();
            threadMatrixKahanBabushka.join();
        } catch (InterruptedException e) {
            Thread.currentThread().interrupt();
            e.printStackTrace();
        }*/
